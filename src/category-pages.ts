...
export const categoryPages:Record<string,Category>={
 ...
 '/stories':{title:'影像与故事',description:'角色档案、藏家影像与投稿。',items:[{title:'藏家自拍',href:'/stories/collectors'},{title:'官方拍图',href:'/stories/official'},{title:'往期序章',href:'/stories/openings'},{title:'投稿与联系',href:'/contact'}]},
