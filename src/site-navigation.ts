...
export const siteNavigation:NavigationItem[]=[
 ...
 {title:'体型与部件',children:[{title:'女体',children:[{title:'女体 60',pending:true},{title:'女体 65',pending:true},{title:'女体 70',children:[{title:'镜昕 · 荷花女神',href:character}]}]},{title:'男体',children:['70','75','80'].map(n=>({title:`男体 ${n}`,pending:true}))},{title:'独立部件',pending:true}]},
 {title:'服饰与配件',children:['娃衣','鞋袜','假发与眼珠','饰品与道具','展示与收纳'].map(title=>({title,pending:true}))},
 {title:'影像与故事',children:[{title:'镜昕 · 角色档案',href:character},{title:'藏家返图',href:'/#collectors'},{title:'投稿与联系',href:'/contact'}]},
